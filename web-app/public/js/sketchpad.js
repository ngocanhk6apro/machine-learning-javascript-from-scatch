class SketchPad {
    ...
    addDrawingUpdateListener(listener) {
        this.#drawingUpdateListeners.push(listener);
    }
    ...
    showMaskAround() {
        this.#canvas.style.outline = "10000px solid rgba(0, 0, 0, 0.7)";
    }
    ...
    #draw() {
        ...
        for(let listener of this.#drawingUpdateListeners) {
            listener(this.#paths);
        }
    }
